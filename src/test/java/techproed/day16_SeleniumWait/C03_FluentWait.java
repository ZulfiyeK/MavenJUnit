...
public class C03_FluentWait extends TestBase {
    ...
    */
    ...
    public void test4() {
        ...
        //Hello World! Yazının sitede oldugunu test et.
        WebElement helloWorld = driver.findElement(By.xpath("(//h4)[2]"));
        visibleFluentWait(helloWorld,20,150);
        Assert.assertEquals("Hello World!", helloWorld.getText());

    }
}
// araliklari kendimiz belirleyebilmemeiz icin pollingevery methodunu sunmus bize..her 200 milisaniye de kontrol edecek webelement gorundu mu diye..
// bu sekilde pollingevery ile kodlari calistirmak ve beklemek daha profesyonelcedir.